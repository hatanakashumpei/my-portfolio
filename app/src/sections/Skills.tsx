...
const skills = [
  ...
  {
    icon: 'src/assets/icons/linux-tux.svg',
    label: 'Linux',
    experience: '6+ years',
    level: 5,
  ...
  {
    icon: 'src/assets/icons/c-sharp.svg',
    label: 'C#',
    experience: '2+ years',
    level: 2,
  ...
  {
    icon: 'src/assets/icons/c-plusplus.svg',
    label: 'C++',
    experience: '3+ years',
    level: 3,
  ...
  {
    icon: 'src/assets/icons/docker-icon.svg',
    label: 'Docker',
    experience: '3+ years',
    level: 4,
  ...
  {
    icon: 'src/assets/icons/google-cloud.svg',
    label: 'GCP',
    experience: '2+ years',
    level: 3,
